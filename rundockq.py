...
for complex in list_ids:
   ...
   for i in range(3): # Add run to dict
      ...
      haddock_nw = f"run{i}/{complex}_nohydrogens_Haddock_nowaters_result.pdb_split_labelled.pdb"
      haddock_w = f"run{i}/{complex}_nohydrogens_Haddock_waters_result.pdb_split_labelled.pdb"
      # Run DockQ
      dockq_results = {}
      # Megadock
