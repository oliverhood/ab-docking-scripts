...
#Program: run_testdockingprogs_master_v3
#File:    run_testdockingprogs_master_v3.sh

#Version:   V4.0
#Date:      16.04.2024
#Function:  Wrapper for running testdockingprogs_master_v4.py on a full directory of PDB files.
...
for file in ${pwd}/*.pdb
   do
      ...
      ~/ab-docking-scripts/testdockingprogs_master_v4.py $file
