...
def rewrite_unambig_tbl(unambig_tbl):
   """
   Function to add segment IDs to the unambig table generated by generate_unambig_tbl.
   """
   # Initiate new file contents list
   contents = []
   # Open unambig file
   with open(unambig_tbl) as file:
      rows = file.readlines()
      # Filter through lines
      for line in rows:
         # Split line into segA and segB
   ...
   # Write new file
   with open(unambig_tbl_name, "w") as file:
